...
interface HMIDataItem {
  /**
   * Value of DataSet-Item
   */
  Value: any;
  /**
...
interface HMIDataSet {
  ...
  Count: number;
  /**
   * Gets one item to DataSet
   *
   *
   * @returns HMIDataItem
   */
  (name: string):HMIDataItem;
  Item(name: string): HMIDataItem;
  /**
   * Adds one item to DataSet
   *
   */
  Add(name: string, data: any): void;
  /**
   * Remove one item in DataSet
   *
   */
  Remove(name: string): void;
  /**
   * Remove all items in DataSet
   */
  RemoveAll(): void;
}
